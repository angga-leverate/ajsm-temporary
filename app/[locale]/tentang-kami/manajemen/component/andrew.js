import tokoiPic from "../../../../../public/img/Andrew.png";
...
export default function hideakinomura() {
  ...
  return (
    <>
      <Link href="#" data-bs-toggle="modal" data-bs-target="#andrew">
        <div className="col-12">
          <div className="card border-0">
            <Image src={tokoiPic} className="img-fluid mx-auto border-0" alt="AJSM" width={200}/>
            <div className="card-body p-0 pt-3">
              <h5 className="card-title text-center">Andrew Bain</h5>
            ...
            <div className="modal-body">
              <div className="row">
                ...
                <div className="col-12 col-md-9 mt-4">
                  ...
                  <div dangerouslySetInnerHTML={{__html: t.raw(`Management.andrew-profile`)}} />
                </div>
              </div>
            </div>
