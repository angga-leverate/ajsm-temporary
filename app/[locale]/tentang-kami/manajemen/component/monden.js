import tokoiPic from "../../../../../public/img/Monden.png";
...
export default function hideakinomura() {
  ...
  return (
    <>
      <Link href="#" data-bs-toggle="modal" data-bs-target="#monden">
        <div className="col-12">
          <div className="card border-0">
            <Image src={tokoiPic} className="img-fluid mx-auto border-0" alt="AJSM" width={200}/>
            <div className="card-body p-0 pt-3">
              <h5 className="card-title text-center">Tomoyuki Monden</h5>
            ...
            <div className="modal-body">
              <div className="row">
                ...
                <div className="col-12 col-md-9 mt-4 ajsm_peoplebody">
                  ...
                  <div dangerouslySetInnerHTML={{__html: t.raw(`Management.monden-profile`)}} />
                </div>
              </div>
            </div>
