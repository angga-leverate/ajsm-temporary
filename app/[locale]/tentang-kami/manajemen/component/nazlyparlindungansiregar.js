...
export default function hideakinomura() {
  ...
  return (
    <>
      <Link href="#" data-bs-toggle="modal" data-bs-target="#nazly">
      ...
      <div
        ...
        id="nazly"
        tabIndex="-1"
        aria-labelledby="nazlyLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-xl">
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5" id="nazlyLabel">
            ...
            <div className="modal-body">
              <div className="row">
                ...
                <div className="col-12 col-md-9 mt-4 ajsm_peoplebody">
                  ...
                  <div dangerouslySetInnerHTML={{__html: t.raw(`Management.nazly-profile`)}} />
                </div>
              </div>
            </div>
