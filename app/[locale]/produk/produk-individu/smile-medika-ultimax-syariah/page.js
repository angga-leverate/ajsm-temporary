              ...
              <header className="pt-4">
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    {t('Produk.smile-medika-ultimax-syariah.title')}
                    </li>
                  </ol>
                </nav>
                <h1 className="page-header-ui-title mb-3">{t('Produk.smile-medika-ultimax-syariah.title')}</h1>
              </header>
            </div>
          </div>
        </div>
                ...
                <div className="row g-4 mb-2">
                  <div className="col-12">
                    <div className="card-body px-0 pt-1">
                      <div dangerouslySetInnerHTML={{__html: t.raw('Produk.smile-medika-ultimax-syariah.content')}} />
                      <h4>{t('Produk.benefit')}</h4>
                      <div dangerouslySetInnerHTML={{__html: t.raw('Produk.smile-medika-ultimax-syariah.benefit')}} />
                      
                    </div>
                    <div className="col-12">
                        <a href="/files/produk/Asuransi_Smile_Medika_Ultima_Syariah.pdf" className="btn btn-ajsm-dark ">{t('Produk.download')}</a>
