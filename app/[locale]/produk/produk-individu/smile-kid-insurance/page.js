              ...
              <header className="pt-4">
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    {t('Produk.smile-kid-insurance.title')}
                    </li>
                  </ol>
                </nav>
                <h1 className="page-header-ui-title mb-3">{t('Produk.smile-kid-insurance.title')}</h1>
              </header>
            </div>
          </div>
        </div>
                ...
                <div className="row g-4 mb-2">
                  <div className="col-12">
                    <div className="card-body px-0 pt-1">
                      <div dangerouslySetInnerHTML={{__html: t.raw('Produk.smile-kid-insurance.content')}} />
                      <h4>{t('Produk.benefit')}</h4>
                      <div dangerouslySetInnerHTML={{__html: t.raw('Produk.smile-kid-insurance.benefit')}} />
                    </div>
                    <div className="col-12">
                        <a href="/files/produk/Asuransi_Jiwa_Smile_Kid_Insurance.pdf" className="btn btn-ajsm-dark ">{t('Produk.download')}</a>
