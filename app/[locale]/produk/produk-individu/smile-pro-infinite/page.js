              ...
              <header className="pt-4">
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    {t('Produk.smile-pro-infinite.title')}
                    </li>
                  </ol>
                </nav>
                <h1 className="page-header-ui-title mb-3">{t('Produk.smile-pro-infinite.title')}</h1>
              </header>
            </div>
          </div>
        </div>
                ...
                <div className="row g-4 mb-2">
                  <div className="col-12">
                    <div className="card-body px-0 pt-1">
                      <div dangerouslySetInnerHTML={{__html: t.raw('Produk.smile-pro-infinite.content')}} />
                      <h4>{t('Produk.benefit')}</h4>
                      <div dangerouslySetInnerHTML={{__html: t.raw('Produk.smile-pro-infinite.benefit')}} />
                    </div>
                    <div className="col-12 d-flex">
                      <div className="dropdown">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                          <li><a href="/files/produk/Asuransi_Jiwa_Smile_Pro_Infinite.pdf" className="dropdown-item">{t('Produk.brochure')}</a></li>
                          <li><a className="dropdown-item" href="/files/produk/ProdukIndividu_Konvensional_RIPLAY Umum Smile pro infinite.pdf">Riplay</a></li>
