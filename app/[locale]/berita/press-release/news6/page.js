...
import placeholderNews from "../../../../../public/img/news/news6.jpeg";
            ...
            <div className="col-12 col-md-8 spr_liputanwrap">
              <div className="card border-0 mt-0">
                <div className="row g-4 mb-2">
                  ...
                  <h1 className="page-header-ui-title mb-3">{t('News.press6-title')}</h1>
                    
                  </div>
                  <div className="col-md-12">
                    <div className="card-body px-0 pt-1 spr_liputantitle">
                    <div dangerouslySetInnerHTML={{__html: t.raw(`News.press6-news`)}} /> 
