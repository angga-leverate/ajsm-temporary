...
import imageD from "../../../../../public/img/news/news4.jpeg";
import imageM from "../../../../../public/img/news/news4en.jpeg";
            ...
            <div className="col-12 col-md-8 spr_liputanwrap">
              <div className="card border-0 mt-0">
                <div className="row g-4 mb-2">
                  ...
                  <h1 className="page-header-ui-title mb-3">{t('News.corp4-title')}</h1>
                    <a href="#" className="">
                  ...
                  <div className="col-md-12">
                    ...
                    <div dangerouslySetInnerHTML={{__html: t.raw(`News.corp4-news`)}} />
                    </div>
                  </div>
                </div>
              </div>
