...
import imageD from "../../../../../public/img/news/news1.jpeg";
import imageM from "../../../../../public/img/news/news1en.jpeg";
              ...
              <div className="card border-0 mt-0">
                <div className="row g-4 mb-2">
                  <div className="col-md-12">
                   <h1 className="page-header-ui-title mb-3">{t('News.corp1-title')}</h1>
                    <a href="#" className="">
                  ...
                  <div className="col-md-12">
                    <div className="card-body px-0 pt-1 spr_liputantitle">
                      <div dangerouslySetInnerHTML={{__html: t.raw(`News.corp1-news`)}} />
                    </div>
                  </div>
                </div>
              </div>
